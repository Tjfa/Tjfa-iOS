...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        UIImageView* indicator = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"refreshIndicator"]];
        indicator.autoresizingMask = UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin;
        [self addSubview:_activityView = indicator];
...
- (void)setFrame:(CGRect)frame
{
    ...
    //    if (w == 0 || _arrowImage.center.y == h * 0.5)
    //        return;
    ...
    _activityView.center = CGPointMake(w / 2, h / 2);
}
...
- (void)indicatorStartRotate
{
    ...
    [_activityView.layer addAnimation:rotationAnimation forKey:@"refreshAnimation"];
}

- (void)indicatorStopRotate
{
    [_activityView.layer removeAnimationForKey:@"refreshAnimation"];
}
