...
- (id)initWithFrame:(CGRect)frame {
    if(self = [super initWithFrame:frame]) {
        ...
        UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"refreshIndicator"]];
        [self setCustomView:imageView forState:SVPullToRefreshStateAll];
    }
...
- (void)indicatorRotateForTriggered
{

}

- (void)indicatorStartRotate
{
    ...
    UIView *activityView = [self.viewForState objectAtIndex:self.state];
    [activityView.layer addAnimation:rotationAnimation forKey:@"refreshAnimation"];
}

- (void)indicatorStopRotate
{
    UIView *activityView = [self.viewForState objectAtIndex:self.state];
    [activityView.layer removeAnimationForKey:@"refreshAnimation"];
}
